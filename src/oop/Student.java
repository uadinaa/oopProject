...
//import JournalWithPatternObserver.Serializable;
...
public class Student extends User implements Serializable{
	...
	public Student(String name,String surname,int id,int yearOfStudy,double gpa,HashMap<Course,Mark> transcript,StudentOrganizations organization, StudentStatus stud_status) {
		super(name,surname);
